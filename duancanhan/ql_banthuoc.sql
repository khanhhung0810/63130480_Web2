...
--
-- Host: 127.0.0.1
-- Generation Time: May 14, 2024 at 06:13 AM
...
CREATE TABLE `products` (
  ...
  `hoat_chat` varchar(100) DEFAULT NULL,
  `chi_dinh` text DEFAULT NULL,
  `dang_bao_che` varchar(100) DEFAULT NULL,
  `noi_san_xuat` varchar(100) DEFAULT NULL,
...
ALTER TABLE `products`
  ...
  ADD KEY `FK5se73bafmlv16jgbdjyepeg0l` (`category_category_id`);
...
--
ALTER TABLE `products`
  ADD CONSTRAINT `FK5se73bafmlv16jgbdjyepeg0l` FOREIGN KEY (`category_category_id`) REFERENCES `categories` (`category_id`),
