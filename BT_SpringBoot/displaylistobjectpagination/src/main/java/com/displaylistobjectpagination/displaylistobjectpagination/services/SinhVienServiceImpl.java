...
public class SinhVienServiceImpl implements SinhvienService {
	...
	static {
					...
					dsSinhVien.add(new SinhVien("0005", "Lữ Huỳnh Khánh Hưng"));
					dsSinhVien.add(new SinhVien("0006", "Trần Văn Long"));
					dsSinhVien.add(new SinhVien("0007", "Lữ Huỳnh Khánh Hưng"));
					dsSinhVien.add(new SinhVien("0008", "Trần Văn Long"));
					dsSinhVien.add(new SinhVien("0009", "Lữ Huỳnh Khánh Hưng"));
					dsSinhVien.add(new SinhVien("0010", "Trần Văn Long"));
					dsSinhVien.add(new SinhVien("0011", "Lữ Huỳnh Khánh Hưng"));
